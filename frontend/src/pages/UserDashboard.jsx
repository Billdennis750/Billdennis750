...
const statusConfig = {
  ...
  deposit_paid: { label: 'Deposit Paid', color: '#8b5cf6', bgColor: '#ede9fe', icon: CheckCircle, description: 'Awaiting loan disbursement approval' },
  ...
  disbursement_declined: { label: 'Disbursement Declined', color: '#ef4444', bgColor: '#fee2e2', icon: AlertCircle, description: 'Disbursement was declined. Please contact support.' },
